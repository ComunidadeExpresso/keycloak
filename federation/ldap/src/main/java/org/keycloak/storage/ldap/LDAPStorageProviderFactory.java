...
public class LDAPStorageProviderFactory implements UserStorageProviderFactory<LDAPStorageProvider>, ImportSynchronization {
    ...
    private static List<ProviderConfigProperty> getConfigProps(ComponentModel parent) {
        ...
        return ProviderConfigurationBuilder.create()
                ...
                .secret(true)
                .add()
                .property().name(LDAPConstants.USE_PWD_CHANGE_SETTINGS)
                .type(ProviderConfigProperty.BOOLEAN_TYPE)
                .defaultValue("false")
                .add()
                .property().name(LDAPConstants.CONNECTION_URL_PWD_CH)
                .type(ProviderConfigProperty.STRING_TYPE)
                .add()
                .property().name(LDAPConstants.START_TLS_PWD_CH)
                .type(ProviderConfigProperty.BOOLEAN_TYPE)
                .add()
                .property().name(LDAPConstants.USE_TRUSTSTORE_SPI_PWD_CH)
                .type(ProviderConfigProperty.STRING_TYPE)
                .defaultValue(LDAPConstants.USE_TRUSTSTORE_ALWAYS)
                .add()
                .property().name(LDAPConstants.CONNECTION_POOLING_PWD_CH)
                .type(ProviderConfigProperty.BOOLEAN_TYPE)
                .defaultValue("true")
                .add()
                .property().name(LDAPConstants.CONNECTION_TIMEOUT_PWD_CH)
                .type(ProviderConfigProperty.STRING_TYPE)
                .add()
                .property().name(LDAPConstants.AUTH_TYPE_PWD_CH)
                .type(ProviderConfigProperty.STRING_TYPE)
                .defaultValue(LDAPConstants.AUTH_TYPE_SIMPLE)
                .add()
                .property().name(LDAPConstants.BIND_DN_PWD_CH)
                .type(ProviderConfigProperty.STRING_TYPE)
                .add()
                .property().name(LDAPConstants.BIND_CREDENTIAL_PWD_CH)
                .type(ProviderConfigProperty.PASSWORD)
                .secret(true)
                .add()
                .property().name(LDAPConstants.PWD_HASHING_FMT)
                .type(ProviderConfigProperty.STRING_TYPE)
                .defaultValue(LDAPConstants.passwordHashingTypes.PLAIN)
                .add()
                .property().name(LDAPConstants.PWD_CHANGED_TIME_CUSTOM_ATTR)
                .type(ProviderConfigProperty.STRING_TYPE)
                .add()
                .property().name(LDAPConstants.PWD_CHANGED_TIME_CUSTOM_FMT)
                .type(ProviderConfigProperty.STRING_TYPE)
                .defaultValue(LDAPConstants.passwordModificationFormat.GENERALIZEDTIME)
                .add()
                .property().name(LDAPConstants.USE_SAMBA_ATTRS)
                .type(ProviderConfigProperty.BOOLEAN_TYPE)
                .defaultValue("false")
                .add()
                .property().name(LDAPConstants.USE_RFC2617_ATTR)
                .type(ProviderConfigProperty.BOOLEAN_TYPE)
                .defaultValue("false")
                .add()
                .property().name(LDAPConstants.RFC2617_REALM)
                .type(ProviderConfigProperty.STRING_TYPE)
                .add()
    ...
    public void validateConfiguration(KeycloakSession session, RealmModel realm, ComponentModel config) throws ComponentValidationException {
        ...
        if (!cfg.usePwdChangeSettings() && cfg.getEditMode() != UserStorageProvider.EditMode.WRITABLE) {
